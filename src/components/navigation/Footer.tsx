      ...
      <Section maxWidth="2xl" padding="xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-4">
              Automation-driven websites, web apps, and AI tools for fashion/retail businesses.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://twitter.com/horizonwebworx"
              ...
              <a
                href="https://linkedin.com/company/horizonwebworx"
                className="text-gray-300 hover:text-white transition-colors"
                aria-label="LinkedIn"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm">
            © {new Date().getFullYear()} HorizonWebWorX. All rights reserved.
          </p>
          <p className="text-gray-300 text-sm mt-4 md:mt-0">
            We also offer Google Profile optimization and SEO to improve Google ranking.
          </p>
        </div>
      </Section>
    </footer>
